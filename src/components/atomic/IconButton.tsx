...
//     'text-sm md:text-base outline-none group',
...
//             'whitespace-nowrap absolute hidden md:block px-1.5 pt-0.5 pb-1 m-2 mx-auto text-sm md:text-base text-gray-100 transition-opacity -translate-x-1/2 translate-y-full bg-gray-800 rounded-md left-1/2 z-50',

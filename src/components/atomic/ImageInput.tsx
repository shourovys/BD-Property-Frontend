...
//   return (
//     <div className="space-y-0.5 md:space-y-1 min-w-max w-full">
//       {label && (
//         <>
//           {handleSelect ? (
...
//             <label
//               className="inline-block w-full text-sm font-medium text-gray-700 md:text-base form-label"
//               htmlFor={name}
//             >
//               {label}
//             </label>
...
//                     />
//                   </svg>
//                   <p className="pt-1 text-sm tracking-wider text-gray-400 md:text-base group-hover:text-gray-600">
//                     {placeholder}
//                   </p>
//                 </>
//               )}
...
//               >
//                 <Icon icon={cancelIcon} className="text-sm md:text-base" />
//               </button>
//             )}
//           </label>
//         </div>
//       )}
//       {error && (
//         <p className="mt-1 text-xs text-red-500 md:text-base md:text-xs">
//           {error}
//         </p>
//       )}
//       {helpText && (
//         <p className="mt-1 text-xs text-gray-500 md:text-base md:text-xs">
//           {helpText}
//         </p>
//       )}
//     </div>

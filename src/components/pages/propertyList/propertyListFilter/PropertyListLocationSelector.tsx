...
const PropertyListLocationSelector: NextPage = () => {
  return (
    <div className='flex items-center justify-between gap-2 overflow-x-auto text-left font-ubuntu text-sm font-medium text-darkslateblue-100 md:flex-wrap md:overflow-hidden md:rounded-6xs md:border md:border-darkslateblue-200 md:bg-gray-300 md:px-4 md:py-4 md:text-base'>
